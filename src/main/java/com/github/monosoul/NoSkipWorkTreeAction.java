...
import static com.github.monosoul.SkipWorkTreeCommands.NO_SKIP_WORKTREE;
...
public class NoSkipWorkTreeAction extends AbstractVcsAction {
    ...
    protected void actionPerformed(@NotNull final VcsContext e) {
        ...
        stream(e.getSelectedFilePaths()).map(FilePath::getPath).forEach(path -> {
            ...
            handler.addParameters(NO_SKIP_WORKTREE, path);
